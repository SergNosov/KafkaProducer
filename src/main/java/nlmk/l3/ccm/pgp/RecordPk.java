...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1599906237510917926L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"nlmk.l3.ccm.pgp\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\",\"doc\":\"Код системы\"},{\"name\":\"id\",\"type\":\"string\",\"doc\":\"ИД единицы металла (ЕМ)\"}]}");
   ...
   * @param id ИД единицы металла (ЕМ)
   */
  public RecordPk(java.lang.CharSequence systemCode, java.lang.CharSequence id) {
   ...
   */
  public static nlmk.l3.ccm.pgp.RecordPk.Builder newBuilder() {
    return new nlmk.l3.ccm.pgp.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.ccm.pgp.RecordPk.Builder newBuilder(nlmk.l3.ccm.pgp.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.l3.ccm.pgp.RecordPk.Builder();
    } else {
      return new nlmk.l3.ccm.pgp.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.ccm.pgp.RecordPk.Builder newBuilder(nlmk.l3.ccm.pgp.RecordPk other) {
    if (other == null) {
      return new nlmk.l3.ccm.pgp.RecordPk.Builder();
    } else {
      return new nlmk.l3.ccm.pgp.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.ccm.pgp.RecordPk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.ccm.pgp.RecordPk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.systemCode)) {
        this.systemCode = data().deepCopy(fields()[0].schema(), other.systemCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.ccm.pgp.RecordPk.Builder setSystemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.ccm.pgp.RecordPk.Builder clearSystemCode() {
      systemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.ccm.pgp.RecordPk.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.ccm.pgp.RecordPk.Builder clearId() {
      id = null;
