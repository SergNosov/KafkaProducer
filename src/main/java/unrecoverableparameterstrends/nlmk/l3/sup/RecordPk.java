...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"unrecoverableparameterstrends.nlmk.l3.nlmk.l3.sup\",\"fields\":[{\"name\":\"id\",\"type\":\"int\",\"doc\":\"Id EM SUP\"}]}");
     ...
     */
    public static unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder newBuilder() {
        return new unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder();
    }
     ...
     * @return A new RecordPk RecordBuilder
     */
    public static unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder newBuilder(unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder other) {
        if (other == null) {
            return new unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder();
        } else {
            return new unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder(other);
        }
    }
     ...
     * @return A new RecordPk RecordBuilder
     */
    public static unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder newBuilder(unrecoverableparameterstrends.nlmk.l3.sup.RecordPk other) {
        if (other == null) {
            return new unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder();
        } else {
            return new unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(unrecoverableparameterstrends.nlmk.l3.sup.RecordPk other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.id)) {
                this.id = data().deepCopy(fields()[0].schema(), other.id);
         ...
         * @return This builder.
         */
        public unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder setId(int value) {
         ...
         * @return This builder.
         */
        public unrecoverableparameterstrends.nlmk.l3.sup.RecordPk.Builder clearId() {
